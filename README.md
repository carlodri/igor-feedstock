About igor-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/igor-feedstock/blob/main/LICENSE.txt)
...
Development: http://blog.tremily.us/posts/igor/

Documentation: http://git.tremily.us/?p=igor.git;a=blob_plain;f=README;hb=HEAD
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5604&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/igor-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `igor` can be installed with `conda`:
...
It is possible to list all of the versions of `igor` available on your platform with `conda`:
...
```
mamba search igor --channel conda-forge
```
...
mamba repoquery search igor --channel conda-forge

# List packages depending on `igor`:
mamba repoquery whoneeds igor --channel conda-forge

# List dependencies of `igor`:
mamba repoquery depends igor --channel conda-forge
```
